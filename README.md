...
**Versão narrativa:** 2.0.71 · **Stack:** React 19 + Vite 6 · **Engine de IA:** OpenAI GPT-4.1 / gpt-4.1-mini / gpt-image-1-mini / Whisper / gpt-4o-mini-tts
...
- **Jest + Testing Library:** cobrem `useGameEngine`, `openaiClient` e `ActionInput`.
