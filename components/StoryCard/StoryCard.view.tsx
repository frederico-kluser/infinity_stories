...
import { MessageType, ChatMessage, ThemeColors, Language } from '../../types';
import { Terminal, Info, Play, Loader2, StopCircle, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const StoryCardView: React.FC<StoryCardProps> = ({
	...
	return (
		<div className="w-full h-full flex flex-col">
			{/* Card Container - Book Page Style */}
			<div
				className="flex-1 relative mx-auto w-full max-w-4xl rounded-sm overflow-hidden transition-all duration-300"
				style={{
					...getCardStyle(),
					boxShadow: `
